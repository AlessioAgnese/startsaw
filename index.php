        ...
        <div class="tile is-ancestor ">
          ...
          <div class="tile is-parent is-vertical">
              ...
              <div class="field">
                ...
                <p class="control has-icons-left">
                  <input name="rePsw" class="input" type="password" placeholder="Password"
                    title="Deve essere uguale alla password inserita precedentemente" path="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required>
                  <span class="icon is-small is-left">
                    <i class="fas fa-lock"></i>
                  </span>
                </p>
